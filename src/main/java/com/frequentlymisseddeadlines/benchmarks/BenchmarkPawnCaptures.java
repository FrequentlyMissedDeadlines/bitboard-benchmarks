...
@Fork(1)
public class BenchmarkPawnCaptures {
    ...
    public void testClassicPawnCaptures() {
        classic.getPawnCaptures(Color.WHITE);
    }

    @Benchmark
    public void testBitboardPawnCaptures() {
        bitboard.getPawnCaptures(Color.WHITE);
    }

    public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
            .include(BenchmarkPawnCaptures.class.getSimpleName())
            .build();
